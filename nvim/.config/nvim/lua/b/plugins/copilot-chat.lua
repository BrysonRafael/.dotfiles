return {
  {
    ...
    config = function()
      ...
      set_keymap('v', '<leader>ce', ':CopilotChatExplain<CR>', { noremap = true, silent = true, desc = '[e]xplain selected code' })
      set_keymap('v', '<leader>cr', ':CopilotChatReview<CR>', { noremap = true, silent = true, desc = '[r]eview selected code' })
      set_keymap('v', '<leader>cf', ':CopilotChatFix<CR>', { noremap = true, silent = true, desc = '[f]ix selected code' })
      set_keymap('v', '<leader>co', ':CopilotChatOptimize<CR>', { noremap = true, silent = true, desc = '[o]ptimize selected code' })
      set_keymap('v', '<leader>cd', ':CopilotChatDocs<CR>', { noremap = true, silent = true, desc = '[d]ocument selected code' })
      set_keymap('v', '<leader>cT', ':CopilotChatTests<CR>', { noremap = true, silent = true, desc = 'write [T]ests for selected code' })
    end,
  },
}
